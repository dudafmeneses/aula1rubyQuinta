...
class SeriadosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seriado" do
    assert_difference("Seriado.count") do
      post seriados_url, params: { seriado: { dataDeLancamento: @seriado.dataDeLancamento, descricao: @seriado.descricao, diretor: @seriado.diretor, episodios: @seriado.episodios, nome: @seriado.nome } }
    end
  ...
  test "should update seriado" do
    patch seriado_url(@seriado), params: { seriado: { dataDeLancamento: @seriado.dataDeLancamento, descricao: @seriado.descricao, diretor: @seriado.diretor, episodios: @seriado.episodios, nome: @seriado.nome } }
